                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("penjualan/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-no_bukti">
                                                        <span  data-value="<?php echo $data['no_bukti']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("penjualan/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="no_bukti" 
                                                    ...
                                                    <td class="td-id_pelanggan">
                                                        <span  data-source='<?php print_link('api/json/penjualan_id_pelanggan_option_list'); ?>' 
                                                            data-value="<?php echo $data['id_pelanggan']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("penjualan/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-id_barang">
                                                        <span  data-source='<?php print_link('api/json/penjualan_id_barang_option_list'); ?>' 
                                                    ...
                                                    <td class="td-harga_jual">
                                                        <span  data-source='<?php print_link('api/json/penjualan_harga_jual_option_list'); ?>' 
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("penjualan/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("penjualan/edit/$rec_id"); ?>">
