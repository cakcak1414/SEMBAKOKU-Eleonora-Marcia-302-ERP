                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-id_pelanggan" name="id_pelanggan"  placeholder="Select a value ..."    class="custom-select" >
                                                            ...
                                                            <?php 
                                                            $id_pelanggan_options = $comp_model -> penjualan_id_pelanggan_option_list();
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-id_barang" name="id_barang"  placeholder="Select a value ..."    class="custom-select" >
                                                            <option value="">Select a value ...</option>
                                                            <?php 
                                                            $id_barang_options = $comp_model -> penjualan_id_barang_option_list();
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-harga_jual" name="harga_jual"  placeholder="Select a value ..."    class="custom-select" >
                                                                    <option value="">Select a value ...</option>
                                                                    <?php 
                                                                    $harga_jual_options = $comp_model -> penjualan_harga_jual_option_list();
                                                                    if(!empty($harga_jual_options)){
                                                                    foreach($harga_jual_options as $option){
                                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                    $selected = $this->set_field_selected('harga_jual',$value, "");
                                                                    ?>
                                                                    <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                                        <?php echo $label; ?>
                                                                    </option>
