                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-no_bukti"> No Bukti</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("pembelian/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-no_bukti">
                                                        <span  data-value="<?php echo $data['no_bukti']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pembelian/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="no_bukti" 
                                                            data-title="Enter No Bukti" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-id_barang">
                                                        <span  data-source='<?php print_link('api/json/pembelian_id_barang_option_list'); ?>' 
                                                            data-value="<?php echo $data['id_barang']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pembelian/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="id_barang" 
                                                    ...
                                                    <td class="td-id_pemasok">
                                                        <span  data-source='<?php print_link('api/json/pembelian_id_pemasok_option_list'); ?>' 
                                                            data-value="<?php echo $data['id_pemasok']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pembelian/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-harga_beli">
                                                        <span  data-source='<?php print_link('api/json/pembelian_harga_beli_option_list'); ?>' 
                                                            data-value="<?php echo $data['harga_beli']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pembelian/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("pembelian/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("pembelian/edit/$rec_id"); ?>">
