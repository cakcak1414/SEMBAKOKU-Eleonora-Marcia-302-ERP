                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <textarea placeholder="Enter Nama Pelanggan" id="ctrl-nama_pelanggan"  required="" rows="5" name="nama_pelanggan" class=" form-control"><?php  echo $data['nama_pelanggan']; ?></textarea>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-telepon"  value="<?php  echo $data['telepon']; ?>" type="text" placeholder="Enter Telepon"  required="" name="telepon"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
