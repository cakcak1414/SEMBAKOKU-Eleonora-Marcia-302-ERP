                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-id_barang"  value="<?php  echo $this->set_field_value('id_barang',""); ?>" type="text" placeholder="Enter Id Barang"  required="" name="id_barang"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-harga_beli"  value="<?php  echo $this->set_field_value('harga_beli',""); ?>" type="number" placeholder="Enter Harga Beli" step="0.1"  required="" name="harga_beli"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-harga_jual"  value="<?php  echo $this->set_field_value('harga_jual',""); ?>" type="number" placeholder="Enter Harga Jual" step="0.1"  required="" name="harga_jual"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
