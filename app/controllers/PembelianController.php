...
class PembelianController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				pembelian.id LIKE ? OR 
				pembelian.no_bukti LIKE ? OR 
				pembelian.tanggal LIKE ? OR 
				pembelian.id_barang LIKE ? OR 
				pembelian.id_pemasok LIKE ? OR 
				pembelian.kuantitas LIKE ? OR 
				pembelian.total LIKE ? OR 
				pembelian.keterangan LIKE ? OR 
				pembelian.harga_beli LIKE ?
			)";
			$search_params = array(
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("pembelian.id", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("pembelian.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("no_bukti","tanggal","id_barang","id_pemasok","kuantitas","total","keterangan","harga_beli");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","no_bukti","tanggal","id_barang","id_pemasok","kuantitas","total","keterangan","harga_beli");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->validate_captcha = true; //will check for captcha validation
			$this->rules_array = array(
	...
	function delete($rec_id = null){
		...
		$db->where("pembelian.id", $arr_rec_id, "in");
